<template>
	<view class="container">
		...
		<view class="contents">
			<button class="cu-btn round bg-blue block margin-tb-sm margin-lr-xs">活动集赞</button>
			<button class="cu-btn round bg-blue block margin-tb-sm margin-lr-xs">好友助力</button>
