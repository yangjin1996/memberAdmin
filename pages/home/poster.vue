<template>
	<view class="container">
		<cu-bar2 bgColor="bg-gradual-orange" :isBack="true"><block slot="content" class="page-name">海报</block></cu-bar2>
...
export default {
	...
	onShow() {
		//this.onInit();
		this.initImage("http://www.homeeyes.cn/app/images/icon_logo.png");
	},
	methods: {
