	...
	<view class="container">
		<view class="page-body uni-content-info" >
			...
			<view class='cropper-config'>
				...
				<button type="warn" @click="getImageInfo" style='margin-top: 30upx;'> 确定上传 </button>
			</view>
...
<script>
	import dialogImage from '../../../components/single/modal/dialog_image.vue'
