<template>
	<view class="calendar-boxs">
		...
		<view v-if="maskShow || insert" :class="{ 'ani-calendar-show': aniMaskShow, 'uni-calendar__static': insert }" class="uni-calendar__box">
			...
			<view class="bg-img" style="background-image: url('https://wxt.homeeyes.cn/app/images/calendar_back0.png'); background-size: 125% 960upx; background-position-y: -100upx;">
...
<script>
	...
	import uniCalendarItem from './uni-calendar-item-total.vue'
	export default {
		name: 'UniCalendar',
		components: {
			uniCalendarItem
...
<style>
	...
	.uni-calendar__wrapper .uni-calenda__content .uni-calendar__panel .uni-calendar__backtoday {
		...
		height: 50rpx;
		line-height: 50rpx;
		border: 1px rgba(45, 140, 21, .5) solid;
		border-right: none;
		font-size: 24rpx;
		border-top-left-radius: 50rpx;
		border-bottom-left-radius: 50rpx;
		color: rgba(45, 140, 21, .5);
